...
namespace Bundle.Client.Palettes
{
    public class PacketPalette112 : PacketTypePalette
    {
        private Dictionary<int, PacketTypeIn> typeIn = new Dictionary<int, PacketTypeIn>()
        {
            ...
            { 0x30, PacketTypeIn.UnlockRecipes },
            { 0x31, PacketTypeIn.DestroyEntities },
            { 0x32, PacketTypeIn.RemoveEntityEffect },
            { 0x33, PacketTypeIn.ResourcePackSend },
            { 0x34, PacketTypeIn.Respawn },
            { 0x35, PacketTypeIn.EntityHeadLook },
            { 0x36, PacketTypeIn.SelectAdvancementTab },
            { 0x37, PacketTypeIn.WorldBorder },
            { 0x38, PacketTypeIn.Camera },
            { 0x39, PacketTypeIn.HeldItemChange },
            { 0x3A, PacketTypeIn.DisplayScoreboard },
            { 0x3B, PacketTypeIn.EntityMetadata },
            { 0x3C, PacketTypeIn.AttachEntity },
            { 0x3D, PacketTypeIn.EntityVelocity },
            { 0x3E, PacketTypeIn.EntityEquipment },
            { 0x3F, PacketTypeIn.SetExperience },
            { 0x40, PacketTypeIn.UpdateHealth },
            { 0x41, PacketTypeIn.ScoreboardObjective },
            { 0x42, PacketTypeIn.SetPassengers },
            { 0x43, PacketTypeIn.Teams },
            { 0x44, PacketTypeIn.UpdateScore },
            { 0x45, PacketTypeIn.SpawnPosition },
            { 0x46, PacketTypeIn.TimeUpdate },
            { 0x47, PacketTypeIn.Title },
            { 0x48, PacketTypeIn.SoundEffect },
            { 0x49, PacketTypeIn.PlayerListHeaderAndFooter },
            { 0x4A, PacketTypeIn.CollectItem },
            { 0x4B, PacketTypeIn.EntityTeleport },
            { 0x4C, PacketTypeIn.Advancements },
            { 0x4D, PacketTypeIn.EntityProperties },
            { 0x4E, PacketTypeIn.EntityEffect },
        };

        private Dictionary<int, PacketTypeOut> typeOut = new Dictionary<int, PacketTypeOut>()
        {
            { 0x00, PacketTypeOut.TeleportConfirm },
            { 0x01, PacketTypeOut.Unknown },
            { 0x02, PacketTypeOut.TabComplete },
            ...
            { 0x0B, PacketTypeOut.InteractEntity },
            { 0x0C, PacketTypeOut.KeepAlive },
            { 0x0D, PacketTypeOut.PlayerMovement },
            { 0x0E, PacketTypeOut.PlayerPosition },
            { 0x0F, PacketTypeOut.PlayerPositionAndRotation },
            { 0x10, PacketTypeOut.PlayerRotation },
            { 0x11, PacketTypeOut.VehicleMove },
            { 0x12, PacketTypeOut.SteerBoat },
